---
title: "隐私政策"
description: "我们是谁 我们的站点地址是：https://blog.lchnan.cn。 我们收集何种及为何收集个人数据 评论 当访客留下评论时，我们会收集评论表单所显示的数据，和访客的IP地址及浏览器的user agent字符串来帮助检查垃圾评论。 由您的电子邮件地址所生成的匿名化字符串（又称为哈希）可能会被提供给Gravatar服务确认您是否有使用该服务。Gravat"
pubDate: "2021-05-30T02:32:05.000Z"
updatedDate: "2021-10-04T02:25:59.000Z"
tags: []
categories: []
wordpressId: 3
oldUrl: "https://blog.lchnan.cn/privacy-policy"
---
## 我们是谁

我们的站点地址是：https://blog.lchnan.cn。
...
本站所有 **文章** 的著作权归 [作者](http://blog.lchnan.cn) 所有。

转载需事先征得作者同意。

转载时需在正文开头显著位置注明作者姓名，给出原始链接，并不得进行任何形式的修改演绎。

如任何组织或个人未经同意转载本站文章，本人将保留一切法律追究权
